========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ColoredListCtrl
========================================================================


Diese ColoredListCtrl-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre ColoredListCtrl-Anwendung bilden.
...
ColoredListCtrl.h
	...
	Anwendungsklasse CColoredListCtrlApp.
...
res\ColoredListCtrl.ico
    	Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei ColoredListCtrl.rc eingebunden.

res\ColoredListCtrl.rc2
...
ColoredListCtrlDlg.h, ColoredListCtrlDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CColoredListCtrlDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in ColoredListCtrl.rc, die mit Microsoft Developer Studio
...
StdAfx.h, StdAfx.cpp
	...
	ColoredListCtrl.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
